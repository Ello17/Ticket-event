            ...
            <div class="col-md-4">
                <div class="card p-4">
                    ...
                    <form action="{{ route('postEditProfileCreator', $user->id) }}" method="POST" class="form-group" enctype="multipart/form-data">
                        ...
                        <label for="profil" class="mt-3">Profile picture (Opsional)</label>
                        ...
                        <a href="{{ route('profilCreator', ['user' => $user->id]) }}" class="btn btn-outline-secondary w-100 mt-2">Back <i class="bi bi-box-arrow-in-right"></i></a>
                    </form>
                </div>
            </div>
        </div>
