            ...
            @if ($event)
                <div class="container mx-auto px-5 mt-10">
                            ...
                            <div class="bg-gray-800 rounded-lg shadow-lg p-6 w-[100%]">
                                ...
                                <div class="text-sm space-y-4">
                                    <div>
                                        ...
                                        <p class="flex events-center text-gray-200">
                                                ...
                                                <div class="tiket-input">
                                                    <div>
                                                        <input type="number" class="form-control text-black"
                                                            name="tiket_dibeli" min="1" max="{{ $tiket->jumlah_tiket }}"
                                                            placeholder="Masukkan jumlah tiket" style="width: 200px;"
                                                            inputmode="numeric">
                                                    </div>
                                                    <div>
                                                        <button type="submit" class="btn btn-warning w-full lg:w-auto">Beli
                                                            Tiket</button>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="my-10">
                        ...
                        <p class="mb-4"><strong>Alamat: </strong><a href="{{ $event->maps }}" class="text-white hover:text-blue-500">{{ $event->lokasi_event }}</a></p>
