        ...
        <div id="sidebar"
            ...
            <nav class="mt-10">
                <ul class="flex flex-col">
                    ...
                    <div class="relative py-3 px-5">
                        ...
                        <ul id="dropdown-user-menu" class="hidden bg-gray-700 mt-1 text-white">
                            ...
                            <li><a class="block px-4 py-2 hover:bg-blue-600 {{ request()->routeIs('pending.users') ? 'bg-blue-500 text-white' : '' }}"
                                    href="{{ route('pending.users') }}"><i class="ri-user-follow-fill mr-2"></i>Approve Creator</a></li>
                        </ul>
                    </div>
                    <div class="relative py-3 px-5">
                    ...
                    <li class="py-3 px-5">
                        <a class="flex items-center text-gray-400 hover:bg-blue-700 hover:text-white rounded-lg py-2 px-4 {{ request()->routeIs('profileAdmin') ? 'bg-blue-500 text-white' : '' }}"
