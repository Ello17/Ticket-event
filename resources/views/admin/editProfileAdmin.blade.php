...
<body>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="card p-4">
                    <h3 class="text-center mb-4">Edit Profile Admin</h3>
                    <form action="{{ route('postEditProfileAdmin', $user->id) }}" method="POST" class="form-group" enctype="multipart/form-data">
                        ...
                        <a href="{{ route('profileAdmin', ['user' => $user->id]) }}" class="btn btn-outline-secondary w-100 mt-2">Back <i class="bi bi-box-arrow-in-right"></i></a>
                    </form>
                </div>
            </div>
        </div>
